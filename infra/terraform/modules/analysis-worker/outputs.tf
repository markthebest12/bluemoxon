# =============================================================================
# Analysis Worker Module Outputs
# =============================================================================

output "queue_url" {
  description = "URL of the SQS queue for analysis jobs"
  value       = aws_sqs_queue.jobs.url
}

output "queue_arn" {
  description = "ARN of the SQS queue for analysis jobs"
  value       = aws_sqs_queue.jobs.arn
}

output "queue_name" {
  description = "Name of the SQS queue for analysis jobs"
