# =============================================================================
# Profile Worker Module
# =============================================================================
# Creates SQS queue + Lambda worker for async Bedrock entity profile generation.
# Enables long-running profile generation jobs that bypass API Gateway's 29s timeout.
# =============================================================================
...
resource "aws_sqs_queue" "dlq" {
  name                      = "${var.name_prefix}-profile-generation-jobs-dlq"
...
resource "aws_sqs_queue" "jobs" {
  name                       = "${var.name_prefix}-profile-generation-jobs"
...
resource "aws_lambda_function" "worker" {
  function_name = "${var.name_prefix}-profile-worker"
...
resource "aws_iam_role" "worker_exec" {
  name = "${var.name_prefix}-profile-worker-exec-role"
...
# Bedrock access for AI-powered profile generation
...
resource "aws_cloudwatch_log_group" "worker" {
  name              = "/aws/lambda/${var.name_prefix}-profile-worker"
...
resource "aws_iam_role_policy" "api_sqs_send" {
  ...
  name  = "sqs-send-profile-generation-jobs"
