...
# =============================================================================
# Creates SQS queue + Lambda worker for async eval runbook generation.
# Enables long-running eval jobs (AI analysis + FMV lookup) that bypass
...
resource "aws_sqs_queue" "dlq" {
  name                      = "${var.name_prefix}-eval-runbook-jobs-dlq"
...
resource "aws_sqs_queue" "jobs" {
  name                       = "${var.name_prefix}-eval-runbook-jobs"
...
resource "aws_lambda_function" "worker" {
  function_name = "${var.name_prefix}-eval-runbook-worker"
...
resource "aws_iam_role" "worker_exec" {
  name = "${var.name_prefix}-eval-runbook-worker-exec-role"
...
# Bedrock access for AI-powered eval runbook generation
...
resource "aws_cloudwatch_log_group" "worker" {
  name              = "/aws/lambda/${var.name_prefix}-eval-runbook-worker"
...
resource "aws_iam_role_policy" "api_sqs_send" {
  ...
  name  = "sqs-send-eval-runbook-jobs"
