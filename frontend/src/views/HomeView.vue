  ...
  <div>
    ...
    <div v-else-if="stats" class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
      ...
      <div class="card">
        ...
        <p class="text-3xl font-bold text-moxon-600 mt-2">{{ stats.primary.count }}</p>
      ...
      <div class="card">
        ...
        <p class="text-3xl font-bold text-moxon-600 mt-2">{{ stats.primary.volumes }}</p>
      ...
      <div class="card">
        ...
        <p class="text-sm text-gray-500 mt-1">
          {{ formatCurrency(stats.primary.value_low) }} - {{ formatCurrency(stats.primary.value_high) }}
        </p>
      </div>
    ...
    <div class="mt-12 grid grid-cols-1 md:grid-cols-3 gap-6">
      ...
      <RouterLink to="/books?inventory_type=PRIMARY&binding_authenticated=true" class="card hover:shadow-lg transition-shadow">
