...
<template>
  <div class="min-h-screen bg-gray-50 p-6">
    <div class="max-w-7xl mx-auto">
      ...
      <!-- Cleanup Tools Panel (Admin Only) -->
      <div v-if="authStore.isAdmin" class="mt-8">
        <div class="bg-white rounded-lg shadow-sm overflow-hidden">
          ...
          <div v-if="cleanupExpanded" class="px-4 pb-4 border-t border-gray-100">
            ...
            <div class="grid grid-cols-2 md:grid-cols-4 gap-3">
              ...
              >
                <span v-if="cleanupLoading === 'all'" class="animate-spin">⏳</span>
                <span v-else>🔄</span>
                Run All
              </button>
              ...
              >
                <span v-if="cleanupLoading === 'stale'" class="animate-spin">⏳</span>
                <span v-else>📦</span>
                Archive Stale
              </button>
              ...
              >
                <span v-if="cleanupLoading === 'expired'" class="animate-spin">⏳</span>
                <span v-else>🔗</span>
                Check Sources
              </button>
              ...
              >
                <span v-if="cleanupLoading === 'archives'" class="animate-spin">⏳</span>
                <span v-else>🗄️</span>
                Retry Archives
              </button>
            </div>
            ...
            <div class="mt-4 p-3 bg-gray-50 rounded-lg">
              ...
              <div class="flex gap-2">
                ...
                >
                  <span v-if="cleanupLoading === 'orphans'" class="animate-spin">⏳</span>
                  <span v-else>🔍</span>
                  Scan Only
                </button>
                <button
            ...
            <!-- Results Display -->
            <div v-if="cleanupResult" class="mt-4 p-3 bg-[var(--color-status-success-bg)] border border-[var(--color-status-success-border)] rounded-lg">
              <h4 class="text-sm font-medium text-[var(--color-status-success-text)] mb-2">Cleanup Results</h4>
            ...
            <!-- Error Display -->
            <div v-if="cleanupError" class="mt-4 p-3 bg-[var(--color-status-error-bg)] border border-[var(--color-status-error-border)] rounded-lg">
