...
<template>
  <div class="max-w-2xl mx-auto">
    ...
    <div class="card mb-8">
      ...
      <div
        v-if="profileError"
        class="bg-[var(--color-status-error-bg)] text-[var(--color-status-error-text)] p-4 rounded-lg text-sm mb-4"
      >
        {{ profileError }}
      </div>
      ...
      <div
        v-if="profileSuccess"
        class="bg-[var(--color-status-success-bg)] text-[var(--color-status-success-text)] p-4 rounded-lg text-sm mb-4"
      >
        {{ profileSuccess }}
      </div>
    ...
    <div class="card mt-8">
      ...
      <div class="flex items-center text-sm">
        <svg
          class="w-5 h-5 text-[var(--color-status-success-accent)] mr-2"
          fill="currentColor"
          viewBox="0 0 20 20"
        >
          <path
