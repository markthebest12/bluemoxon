...
export const useDashboardStore = defineStore("dashboard", () => {
  ...
  // Changed from 30 days to align with backend default and show more acquisition history.
  // See commit a4f9089 "fix: Change dashboard API call from 30 to 90 days"
