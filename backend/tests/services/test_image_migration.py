...
class TestMigrateStage2:
    ...
    def test_skips_non_png(self):
        ...
        errors = []
        result = migrate_stage_2(mock_s3, "bucket", False, None, errors)
    ...
    def test_dry_run_does_not_copy(self):
        ...
        errors = []
        result = migrate_stage_2(mock_s3, "bucket", dry_run=True, limit=None, errors=errors)
    ...
    def test_real_execution_copies_to_jpg(self):
        ...
        errors = []
        result = migrate_stage_2(mock_s3, "bucket", dry_run=False, limit=None, errors=errors)
    ...
    def test_limit_parameter_stops_processing(self):
        ...
        errors = []
        result = migrate_stage_2(mock_s3, "bucket", False, limit=1, errors=errors)
    ...
    def test_skips_if_jpg_already_exists(self):
        ...
        assert result.stats["already_exists"] == 1
    ...
    def test_truncated_image_handling(self):
        ...
        assert result.stats["skipped_not_jpeg"] == 1
        assert result.stats["processed"] == 1
        assert len(errors) == 1
...
class TestCleanupStage3:
    ...
    def test_skips_when_no_jpg(self):
        ...
        errors = []
        result = cleanup_stage_3(mock_s3, "bucket", False, None, errors)

        assert result.stats["skipped_no_jpg"] == 1
    ...
    def test_dry_run_does_not_delete(self):
        ...
        errors = []
        result = cleanup_stage_3(mock_s3, "bucket", dry_run=True, limit=None, errors=errors)
    ...
    def test_real_execution_deletes(self):
        ...
        mock_s3.delete_objects.return_value = {"Deleted": [{"Key": "books/thumb_123/image.png"}]}

        errors = []
        result = cleanup_stage_3(mock_s3, "bucket", dry_run=False, limit=None, errors=errors)
    ...
    def test_limit_parameter_stops_processing(self):
        ...
        errors = []
        result = cleanup_stage_3(mock_s3, "bucket", False, limit=2, errors=errors)
    ...
    def test_skips_non_png(self):
        ...
        mock_s3.head_object.return_value = {"ContentType": "image/jpeg"}
        # Return successful deletion
        mock_s3.delete_objects.return_value = {"Deleted": [{"Key": "books/thumb_1/b.png"}]}
...
class TestBatchDeleteWithErrors:
    ...
    def test_successful_delete(self):
        ...
        mock_s3.delete_objects.return_value = {"Deleted": [{"Key": "a.png"}, {"Key": "b.png"}]}
        errors = []
        stats = {"deleted": 0, "errors": 0}
        ...
        mock_s3.delete_objects.assert_called_once_with(Bucket="bucket", Delete={"Objects": objects})
        assert len(errors) == 0
    ...
    def test_partial_failure(self):
        ...
        mock_s3.delete_objects.return_value = {
            ...
            "Errors": [{"Key": "b.png", "Code": "InternalError", "Message": "Server error"}],
        }
        errors = []
        stats = {"deleted": 0, "errors": 0}
